...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lanekeeping: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lanekeeping ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/LaneInfo.o: LaneInfo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LaneInfo.o LaneInfo.cpp

${OBJECTDIR}/LineSegment.o: LineSegment.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LineSegment.o LineSegment.cpp

${OBJECTDIR}/MSAC.o: MSAC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MSAC.o MSAC.cpp
...
${OBJECTDIR}/UDP_Connection.o: UDP_Connection.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UDP_Connection.o UDP_Connection.cpp
...
${OBJECTDIR}/lmmin.o: lmmin.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lmmin.o lmmin.c

${OBJECTDIR}/mavlink_control.o: mavlink_control.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mavlink_control.o mavlink_control.cpp
